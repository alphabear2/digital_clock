...
const uint8_t code font_cp1251_07[] = {
	...
	0x0C, 0x12, 0x3F, 0x12, 0x04,		// 0x5C => ў
...
//	0x7F, 0x7F, 0x7F, 0x7F, 0x7F,		// 0x9F =>
	...
	0x3F, 0x44, 0x44, 0x44, 0x3F,		// 0xC0 => А
	0x7F, 0x49, 0x49, 0x49, 0x46,		// 0xC1 => Б
	0x7F, 0x49, 0x49, 0x49, 0x36,		// 0xC2 => В
	0x7F, 0x40, 0x40, 0x40, 0x60,		// 0xC3 => Г
	0x03, 0x3E, 0x42, 0x7E, 0x03,		// 0xC4 => Д
	0x7F, 0x49, 0x49, 0x49, 0x41,		// 0xC5 => Е
	0x77, 0x08, 0x7F, 0x08, 0x77,		// 0xC6 => Ж
	0x41, 0x49, 0x49, 0x49, 0x36,		// 0xC7 => З
	0x7F, 0x04, 0x08, 0x10, 0x7F,		// 0xC8 => И
	0x3F, 0x02, 0x64, 0x08, 0x3F,		// 0xC9 => Й
	0x7F, 0x08, 0x14, 0x22, 0x41,		// 0xCA => К
	0x01, 0x1E, 0x20, 0x40, 0x7F,		// 0xCB => Л
	0x7F, 0x20, 0x18, 0x20, 0x7F,		// 0xCC => М
	0x7F, 0x08, 0x08, 0x08, 0x7F,		// 0xCD => Н
	0x3E, 0x41, 0x41, 0x41, 0x3E,		// 0xCE => О
	0x7F, 0x40, 0x40, 0x40, 0x7F,		// 0xCF => П
										            
	0x7F, 0x48, 0x48, 0x48, 0x30,		// 0xD0 => Р
	0x3E, 0x41, 0x41, 0x41, 0x22,		// 0xD1 => С
	0x40, 0x40, 0x7F, 0x40, 0x40,		// 0xD2 => Т
	0x70, 0x09, 0x09, 0x09, 0x7E,		// 0xD3 => У
	0x3C, 0x42, 0xFF, 0x42, 0x3C,		// 0xD4 => Ф
	0x63, 0x14, 0x08, 0x14, 0x63,		// 0xD5 => Х
	0x7F, 0x01, 0x01, 0x7F, 0x01,		// 0xD6 => Ц
	0x70, 0x08, 0x08, 0x08, 0x7F,		// 0xD7 => Ч
	0x7F, 0x01, 0x7F, 0x01, 0x7F,		// 0xD8 => Ш
	0x7E, 0x02, 0x7E, 0x02, 0x7F,		// 0xD9 => Щ
	0x00, 0x45, 0x7C, 0x45, VOID, 		// Символ 175 <Ї>
	//0x40, 0x7F, 0x09, 0x09, 0x06,		// 0xDA => Ъ
	0x00, 0x44, 0x7D, 0x44, VOID, 		// Символ 178 <І>
	//0x7F, 0x09, 0x06, 0x00, 0x7F,		// 0xDB => Ы
	0x7F, 0x09, 0x11, 0x11, 0x0E,		// 0xDC => Ь
	0x3E, 0x49, 0x49, 0x41, 0x22, 		// Символ 170 <Є>
	//0x22, 0x41, 0x49, 0x49, 0x3E,		// 0xDD => Э
	0x7F, 0x08, 0x3E, 0x41, 0x3E,		// 0xDE => Ю
	0x31, 0x4A, 0x4C, 0x48, 0x7F,		// 0xDF => Я
										            
	0x02, 0x15, 0x15, 0x15, 0x0F,		// 0xE0 => а
	0x1E, 0x29, 0x29, 0x49, 0x06,		// 0xE1 => б
	0x1F, 0x15, 0x15, 0x0A, VOID,		// 0xE2 => в
	0x1F, 0x10, 0x10, 0x18, VOID,		// 0xE3 => г
	0x03, 0x0E, 0x12, 0x1E, 0x03,		// 0xE4 => д
	0x0E, 0x15, 0x15, 0x15, 0x0C,		// 0xE5 => е
	0x1B, 0x04, 0x1F, 0x04, 0x1B,		// 0xE6 => ж
	0x11, 0x15, 0x15, 0x0A, VOID,		// 0xE7 => з
	0x1F, 0x02, 0x04, 0x08, 0x1F,		// 0xE8 => и
	0x1F, 0x42, 0x24, 0x48, 0x1F,		// 0xE9 => й
	0x1F, 0x04, 0x0A, 0x11, VOID,		// 0xEA => к
	0x07, 0x08, 0x10, 0x1F, VOID,		// 0xEB => л
	0x1F, 0x08, 0x04, 0x08, 0x1F,		// 0xEC => м
	0x1F, 0x04, 0x04, 0x1F, VOID,		// 0xED => н
	0x0E, 0x11, 0x11, 0x11, 0x0E,		// 0xEE => о
	0x1F, 0x10, 0x10, 0x1F, VOID,		// 0xEF => п
										            
	0x1F, 0x14, 0x12, 0x12, 0x0C,		// 0xF0 => р
	0x0E, 0x11, 0x11, 0x11, 0x02,		// 0xF1 => с
	0x10, 0x10, 0x1F, 0x10, 0x10,		// 0xF2 => т
	0x18, 0x05, 0x05, 0x05, 0x1E,		// 0xF3 => у
	0x0C, 0x12, 0x9F, 0x12, 0x0C,		// 0xF4 => ф
	0x11, 0x0A, 0x04, 0x0A, 0x11,		// 0xF5 => х
	0x1F, 0x01, 0x01, 0x1F, 0x01,		// 0xF6 => ц
	0x18, 0x04, 0x04, 0x1F, VOID,		// 0xF7 => ч
	0x1F, 0x01, 0x1F, 0x01, 0x1F,		// 0xF8 => ш
	0x1E, 0x02, 0x1E, 0x02, 0x1F,		// 0xF9 => щ
	0x00, 0x4A, 0x78, 0x42, VOID, 		// Символ 191 <ї>
	0x00, 0x48, 0x7A, 0x40, VOID, 		// Символ 179 <і>
	//0x10, 0x1F, 0x05, 0x05, 0x02,		// 0xFA => ъ
	//0x1F, 0x05, 0x02, 0x00, 0x1F,		// 0xFB => ы
	0x1F, 0x05, 0x05, 0x02, VOID,		// 0xFC => ь
	0x38, 0x54, 0x54, 0x44, VOID, 		// Символ 186 <є>
	//0x0A, 0x11, 0x15, 0x15, 0x0E,		// 0xFD => э
	0x1F, 0x04, 0x0E, 0x11, 0x0E,		// 0xFE => ю
	0x08, 0x15, 0x16, 0x14, 0x1F,		// 0xFF => я
};
